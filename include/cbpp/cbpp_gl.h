...
#define cb_GetProcAddress(name) { load_result = load_result | cb_GetProcAddress_(name, #name); }
...
GLAPI void (GLAPIENTRY* glGetDoublev)(GLenum pname, GLdouble* data);
...
GLAPI void (GLAPIENTRY* glDepthRange)(GLdouble n, GLdouble f);
...
GLAPI void (GLAPIENTRY* glBindFragDataLocationIndexed)(GLuint program, GLuint colorNumber, GLuint index, const GLchar* name);
...
GLAPI void (GLAPIENTRY* glDrawTransformFeedback)(GLenum mode, GLuint id);
...
GLAPI void (GLAPIENTRY* glProgramUniform1d)(GLuint program, GLint location, GLdouble v0);
...
GLAPI void (GLAPIENTRY* glProgramUniform2d)(GLuint program, GLint location, GLdouble v0, GLdouble v1);
...
GLAPI void (GLAPIENTRY* glProgramUniform3d)(GLuint program, GLint location, GLdouble v0, GLdouble v1, GLdouble v2);
...
GLAPI void (GLAPIENTRY* glProgramUniform4d)(GLuint program, GLint location, GLdouble v0, GLdouble v1, GLdouble v2, GLdouble v3);
...
GLAPI void (GLAPIENTRY* glVertexAttribLPointer)(GLuint index, GLint size, GLenum type, GLsizei stride, const void* pointer);
...
GLAPI void (GLAPIENTRY* glScissorIndexed)(GLuint index, GLint left, GLint bottom, GLsizei width, GLsizei height);
GLAPI void (GLAPIENTRY* glScissorIndexedv)(GLuint index, const GLint* v);
GLAPI void (GLAPIENTRY* glDepthRangeArrayv)(GLuint first, GLsizei count, const GLdouble* v);
GLAPI void (GLAPIENTRY* glDepthRangeIndexed)(GLuint index, GLdouble n, GLdouble f);
GLAPI void (GLAPIENTRY* glGetFloati_v)(GLenum target, GLuint index, GLfloat* data);
GLAPI void (GLAPIENTRY* glGetDoublei_v)(GLenum target, GLuint index, GLdouble* data);
...
GLAPI void (GLAPIENTRY* glDrawElementsInstancedBaseInstance)(GLenum mode, GLsizei count, GLenum type, const void* indices, GLsizei instancecount, GLuint baseinstance);
...
GLAPI void (GLAPIENTRY* glDrawTransformFeedbackInstanced)(GLenum mode, GLuint id, GLsizei instancecount);
...
GLAPI void (GLAPIENTRY* glGetInternalformati64v)(GLenum target, GLenum internalformat, GLenum pname, GLsizei count, GLint64* params);
...
GLAPI void (GLAPIENTRY* glGetNamedFramebufferParameteriv)(GLuint framebuffer, GLenum pname, GLint* param);
...
GLAPI void (GLAPIENTRY* glTextureBufferRange)(GLuint texture, GLenum internalformat, GLuint buffer, GLintptr offset, GLsizeiptr size);
...
GLAPI void (GLAPIENTRY* glCompressedTextureSubImage1D)(GLuint texture, GLint level, GLint xoffset, GLsizei width, GLenum format, GLsizei imageSize, const void* data);
...
GLAPI void (GLAPIENTRY* glCompressedTextureSubImage3D)(GLuint texture, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLsizei imageSize, const void* data);
...
GLAPI void (GLAPIENTRY* glTextureParameterfv)(GLuint texture, GLenum pname, const GLfloat* param);
...
GLAPI void (GLAPIENTRY* glTextureParameteriv)(GLuint texture, GLenum pname, const GLint* param);
...
GLAPI void (GLAPIENTRY* glGetnCompressedTexImage)(GLenum target, GLint lod, GLsizei bufSize, void* pixels);
GLAPI void (GLAPIENTRY* glGetnTexImage)(GLenum target, GLint level, GLenum format, GLenum type, GLsizei bufSize, void* pixels);
...
GLAPI void (GLAPIENTRY* glMultiDrawArraysIndirectCount)(GLenum mode, const void* indirect, GLintptr drawcount, GLsizei maxdrawcount, GLsizei stride);
GLAPI void (GLAPIENTRY* glMultiDrawElementsIndirectCount)(GLenum mode, GLenum type, const void* indirect, GLintptr drawcount, GLsizei maxdrawcount, GLsizei stride);
